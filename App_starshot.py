...
#        """Updates GRP_Starshot with a new opencv image"""
#        rgb_image = cv2.cvtColor(cv_img, cv2.COLOR_BGR2RGB)
#        h, w, ch = rgb_image.shape
#        bytes_per_line = ch * w
#        convert_to_Qt_format = QtGui.QImage(rgb_image.data, w, h, bytes_per_line, QtGui.QImage.Format_RGB888)
...
#        qt_img = QPixmap.fromImage(p)
#        self.GRP_Starshot.setPixmap(qt_img)
...
#        qt_img = QPixmap.fromImage(p)
#        self.GRP_Analyzed.setPixmap(qt_img)                    
    ...
    def F_Merge(self):         
        ...
        # self.GRP_Starshot.fitInView(QtCore.QRectF(0,0,w,h), QtCore.Qt.KeepAspectRatio) 
        # self.GRP_Starshot.show()       
        self.scene_starshot.update()       
    ...
    def F_Apply_Laser(self):
        ...
        crop_laser_gray = np.array(crop_laser) #crop_laser_img
    ...
    def F_Apply_DR(self):
        ...
        for cnt in contours:
            ...
            if radius > 5 and radius < 10:
                self.dr_x = xx + int(crop_h/2)-100 #w
                self.dr_y = yy + int(crop_w/2)-100 #h
    ...
    def F_Analysis(self):        
        ...
        # Add the QLabel object to the layout of the main window
        #layout = QtWidgets.QVBoxLayout()
        #layout.addWidget(label)
        #self.GRP_Analyzed.setLayout(layout)
               
        #widget = QtWidgets.QWidget()
        #widget.setLayout(layout)
        #self.setCentralWidget(widget)
        
        #self.scene_analyzed.addPixmap(QtGui.QPixmap.fromImage(pylinac_starshot))        
        #self.GRP_Analyzed.setScene(self.scene_analyzed)
        #self.GRP_Analyzed.fitInView(QtCore.QRectF(0,0,w,h), QtCore.Qt.KeepAspectRatio)     
        #self.scene_analyzed.update()
